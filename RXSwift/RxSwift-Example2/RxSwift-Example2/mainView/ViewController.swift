...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var throuting: UIButton!
...
//        )
        ...
        self.throuting
            ...
            .subscribe(onNext: {(_) in print("throttle")}).disposed(by: disposeBag)
        
        self.debounceButton
            .rx
            .tap
            .debounce(2, scheduler: MainScheduler.asyncInstance)
            .subscribe(onNext: {(_) in print("deponse")}).disposed(by: disposeBag)
